...
description: Start Building Dapp with Platform
---
...
Obelisk Engine is a framework for ambitious Sui applications. It compresses the complexity of building Move apps with a tightly integrated software stack.
...
- Obelisk Engine **is not specific to Sui Mainnet**: It works on any Move-compatible chains. Sui,Aptos,Starcoin you name it.
